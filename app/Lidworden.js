    ...
    if (this.state.screenMode == "form") {
      screenContent = (
        <Row>
          <Col xs={12} md={4}>
            <h1>Lid worden</h1>
            <p>Onze leden vormen de ruggengraat van de Piratenpartij. </p>
            ...
            <p>
              Na het invullen van postcode & huisnummer wordt het adres
            ...
            >
              ...
              <Row>
                <OurInput
                  ...
                  label="Postcode"
                  required
                  modifier={this.postcodeModifier}
                  validator={this.postcodeValidator.bind(this)}
                  name="postcode"
                />
                <OurInput
                  xs={12}
              ...
              <Row>
                ...
                <OurInput
                  xs={12}
                  sm={6}
                  label="E-mailadres (herhaling)"
                  required
                  validator={this.emailHerhalingValidator.bind(this)}
                  name="emailHerhaling"
                  type="email"
                />
              </Row>
      ...
      screenContent = (
        <div>
          ...
          <br />
          <br />
          Er volgt nu een handmatige controle, waarna we per e-mail contact met
